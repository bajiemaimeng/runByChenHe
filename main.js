var link, jsGame;
(function () {
    var e = window.eval, t = function (e, t, n) {
        var r = n || {};
        if (t) {
            var i = function () {
            };
    ...
    var n = {
        ...
        event: {
            key: 0,
            keys: {up: !1, down: !1, left: !1, right: !1, a: !1, b: !1, c: !1, menu: !1, quit: !1},
        ...
        buttonLayout: {
            buttons: [], Button: t(function (e) {
                ...
                refresh: function () {
                    ...
                    if (this.value != "") {
                        var e = m.canvas.font(this.font).measureText(this.value), t = this.width - e.width >> 1, n = (this.height - e.height >> 1) + parseInt(this.font) - 2;
        ...
        event: {key: {up: 38, down: 40, left: 37, right: 39, a: 90, b: 88, c: 67, menu: 49, quit: 50}},
        system: {gameFlowType: {menu: 0, run: 1, stop: 2, over: 3, zone: 4, active: 5, loadImage: 6, loadedImage: 7}}
    }, i = {
        getCanvasDom: function () {
            ...
            return e.indexOf("duopaosafari") != -1 ? {
                ...
                touch: !1,
                zoom: 1
            } : e.indexOf("opera") != -1 ? {device: "opera", fps: 1, touch: !1, zoom: 1} : {
                device: "",
                fps: 1,
                touch: !1,
                zoom: 1
            ...
            var i = m.canvas.screen.getWidth(), s = m.canvas.screen.getHeight(), o = i, u = 5, a = parseInt(i - o >> 1), f = s - u, e = e > t ? t : e, l = parseInt(e / t * 100) + "%";
    ...
    }, s, o, u, a, f, l, c, h, p, d, v = {arr: [], len: 0, v: 0};
    link = {
        init: function (e, t) {
        ...
        ajax: function (e) {
            ...
            if (n.ajax.xhrObj == null && n.ajax.pool.length > 0) {
                ...
                r.type == "GET" && (i += "?" + s), t.open(r.type, i, !0), r.before(n.ajax.xhrObj), r.type == "POST" && t.setRequestHeader("Content-Type", "application/x-www-form-urlencoded;charset=UTF-8"), t.send(s), t = r = s = o = i = null, n.ajax.date = setTimeout(function () {
                    m.ajax({clear: !0}), n.ajax.isTimeout = !0, n.ajax.xhrObj && (n.ajax.xhrObj.error(n.ajax.xhrObj, "timeout"), n.ajax.xhrObj = null)
...
//e.setItem=function(){}
        ...
        canvas: {
            init: function () {
                return o = {x: 0, y: 0}, u = {fillColor: "#000000", strokeColor: "#000000"}, a = {x: 0, y: 0}, f = {
                    x: 0,
                    y: 0
                }, l = {x: 0, y: 0, fillStyle: "#FFFFFF", strokeStyle: "#CCCCCC"}, this.pass()
            }, initDevice: function () {
                ...
                var h = parseInt(f >> 1), p = parseInt(l >> 1), d = m.getImage(e), v = d.src ? d : n.canvas.cavansDoms[e];
                ...
                return {width: this.screen.getDevice() == "j2me" ? s.measureText(e) : n, height: r}
        ...
        getImage: function (e) {
            return n.image.imgs[e] ? n.image.imgs[e] : {src: null}
        },
        ...
        getAsyncImage: function (e) {
            return n.image.asyncImgObjs[e] ? n.image.asyncImgObjs[e] : {src: null}
        },
    ...
    var m = jsGame = link, g = document.getElementsByTagName("head")[0], y = null, b = null, w = null, E = null, S = function () {
    ...
    var t = function (e, t) {
        ...
        if (s.length > 0) {
            ...
            for (var a = 0; a < s.length; a++) {
                i = [], u = s[a].frames;
                for (var f = 0; f < u.length; f++)i.push({args: [u[f][0], u[f][1], u[f][2]], step: u[f][3]});
    ...
    e.asyncImage([{id: "host", src: "xiaoren.png"}]);
    var t = ["host"], n = [[[0, 0, 26, 37], [27, 0, 19, 36], [46, 0, 22, 38]]], r = [{
        ...
        bR: [-10, -25, 20, 20],
        fA: [[0, 2, -12, -37, 0]]
    }], i = [{loop: !0, frames: [[0, 0, 0, 0], [1, 0, 0, 0], [2, 0, 0, 0], [1, 0, 0, 0]]}];
    return {
        get: function (s, o) {
            var u = s >= 0 && i[s] ? [i[s]] : i;
    ...
    e.asyncImage([{id: "shine", src: "wu.png"}]);
    var t = ["shine"], n = [[[0, 20, 101, 64], [119, 19, 112, 66], [238, 13, 140, 80], [391, 0, 103, 100]]], r = [{
        ...
        bR: [-10, -25, 20, 20],
        fA: [[0, 2, -58, -35, 0]]
    }, {aR: [-15, -30, 30, 30], bR: [-10, -25, 20, 20], fA: [[0, 3, -49, -45, 0]]}], i = [{
        loop: !1,
    ...
    return {
        init: function () {
            ...
            var l = {
                ...
                if (l.time > 10000) {
                    dp_share(l.time);
                    alert("疯狂达人！你居然坚持了" + l.time / 1000 + "秒！")
                }
                ;
                e.buttonLayout.clear().create({
                    id: "return",
...
}), require.config({baseUrl: "js"}), require(["lib/link", "index"], function (e, t) {
    e.init(window.innerWidth, window.innerHeight).pushImage([{id: "logo", src: "ygdbns.jpg"}, {
        id: "btns1",
        src: "gdyx.png"
    }], function (e, t, n) {
    }).initAudio([{id: "1", src: "sound/1.mp3", preload: !0}]).loadingCallBack(function (e, t) {
    }).main(function () {
        t.init()
    })
